...
window.DangerZones = {
      ...
      marker.bindPopup(`
        <div style="font-family:'Inter',sans-serif; text-align:center; padding:5px;">
          ...
          <div style="display:flex; gap:6px; justify-content:center;">
            <button data-action="DangerZones.voteHazard('${hazard.id}', 'confirm')" style="background:#00ff88; color:#000; border:none; border-radius:6px; padding:4px 8px; font-size:0.75rem; font-weight:bold; cursor:pointer;">
              👍 Toujours là
            </button>
            <button data-action="DangerZones.voteHazard('${hazard.id}', 'resolve')" style="background:#ff4d4d; color:#fff; border:none; border-radius:6px; padding:4px 8px; font-size:0.75rem; font-weight:bold; cursor:pointer;">
              👎 Disparu
            </button>
          </div>
        </div>
  ...
  showToast: function (typeInfo, distanceMeters) {
    const existing = document.getElementById("dz-toast");
