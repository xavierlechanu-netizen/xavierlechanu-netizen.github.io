...
window.PredictiveMeca = {
  ...
  updateWear: function (intensity, speed, braking, temp) {
    ...
    // Cap usure à 100%
    for (const part in this.wearScore) {
...
modal.innerHTML = `
            <div class="glassmorphism" style="padding:30px; text-align:center; max-width:90%;">
                ...
                <div style="display:flex; justify-content:space-between; margin-top:20px;">
                    <button class="btn-primary" data-action="document.getElementById('predictive-meca-modal').classList.add('hidden')">Terminer</button>
                    <button class="btn-secondary" data-action="MecaWizard.startAcousticAnalysis()"><i class="fa-solid fa-microphone"></i> Écoute Acoustique</button>
                </div>
            </div>
