        ...
        (g) => `
            <div class="card" style="border-left:4px solid #f1c40f; margin-bottom:10px;">
                ...
                <div style="display:flex; gap:8px; margin-top:10px;">
                    ...
                    <button data-action="window.setRoute('${g.address}')" style="flex:1; background:var(--neon-blue); color:#000; border:none; border-radius:8px; padding:6px; font-size:0.75rem; cursor:pointer; font-weight:bold;">
...
content.innerHTML = `<h3><i class="fa-solid fa-box-archive"></i> ${t.title}</h3>
            ...
            ${
              hasData
                ...
                <button data-action="window.BlackBoxReplay.replay()" class="btn-insurance" style="width:100%; margin-bottom:10px; background:#3498db;">
                ...
                <button data-action="window.DisputeAutomation.initiateDispute()" class="btn-insurance" style="width:100%; margin-top:10px; background:linear-gradient(135deg,#34495e,#2c3e50); color:white; border:1px solid #555;">
  ...
  for (const [type, doc] of Object.entries(docs)) {
    ...
    html += `
            <div style="background:rgba(255,255,255,0.05); padding:10px; border-radius:8px; border-left:3px solid #2ecc71; margin-bottom:10px; display:flex; justify-content:space-between; align-items:center;">
                ...
                <button data-action="window.showWalletDoc('\${type}')" style="background:#2ecc71; color:white; border:none; border-radius:5px; padding:5px 10px; font-size:0.7rem;">VOIR</button>
            </div>
        `;
  }
...
overlay.innerHTML = `
        ...
        <button data-action="this.parentElement.remove()" style="margin-top:20px; padding:10px 20px; background:#444; color:white; border:none; border-radius:8px; font-weight:bold;">FERMER</button>
    `;
...
// --- Action Registry (ESM) ---
registerAction('triggerActualUpload', triggerActualUpload);
