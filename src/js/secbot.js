...
content.innerHTML = `
            <div id="secbot-hud" style="font-family: 'JetBrains Mono', monospace; color: #2ecc71;">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px; margin-bottom:15px;">
                    <button data-action="window.SecBot.runSystemAudit()" class="secbot-action-btn">
                        <i class="fa-solid fa-microchip"></i> AUDIT SYSTÈME
                    </button>
                    <button data-action="window.SecBot.scanIP()" class="secbot-action-btn">
                        <i class="fa-solid fa-globe"></i> ANALYSE IP/PROXY
                    </button>
                </div>
                <button data-action="window.SecBot.testShield()" class="secbot-action-btn" style="width:100%; margin-bottom:20px; background:rgba(46,204,113,0.1); border:1px solid #2ecc71; color:#2ecc71;">
                ...
                <div style="display:flex; gap:10px; margin-bottom:15px;">
                    ...
                    <button data-action="window.SecBot.sendMessage()" style="background:#2ecc71; color:black; border:none; border-radius:8px; padding:0 15px; cursor:pointer; font-weight:bold; transition:transform 0.2s;"><i class="fa-solid fa-paper-plane"></i></button>
                </div>
