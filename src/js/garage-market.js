...
modal.innerHTML = `
            <div style="background:rgba(20,20,20,0.9); border:1px solid #ffaa00; border-radius:15px; padding:30px; width:90%; max-width:400px; text-align:center;">
                ...
                <button data-action="window.GarageMarket.postTrade()" style="width:100%; background:#ffaa00; border:none; color:#000; padding:12px; border-radius:20px; font-weight:bold; cursor:pointer; margin-bottom:10px;">Publier sur la carte</button>
                <button data-action="document.getElementById('market-modal').style.display='none'" style="width:100%; background:transparent; border:1px solid #aaa; color:#fff; padding:10px; border-radius:20px; cursor:pointer;">Annuler</button>
            </div>
        `;
