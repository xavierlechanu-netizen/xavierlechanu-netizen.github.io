...
consoleOverlay.innerHTML = `
        <button data-action="document.getElementById('ai-evolution-console'.classList.add('hidden')" style="position:absolute); top:20px; right:20px; background:none; border:none; color:#0f0; font-size:2rem; cursor:pointer;"><i class="fa-solid fa-power-off"></i></button>
