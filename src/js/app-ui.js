      ...
      // eslint-disable-next-line no-restricted-syntax
        content.innerHTML = `<h3><i class="fa-solid fa-warehouse"></i> ${t("garage_title")}</h3>
            ...
            <div class="card" style="border: 1px solid var(--neon-blue); background: rgba(0, 210, 255, 0.05;">
                ...
                <button data-action="resetTelemetry()" style="width:100%; height:25px; margin-top:10px; background:transparent; border:1px solid #444; color:#666; font-size:0.6rem; border-radius:15px;">RÃƒ‰INITIALISER LES STATS</button>
            </div>
...
content.innerHTML = `<h3><i class="fa-solid fa-briefcase"></i> ${t("pro_space_title")}</h3>
            ...
            <div class="card" style="border:1px solid #f1c40f;">
                ...
                <button data-action="publishFlashOffer()" class="btn-insurance" style="background:#f1c40f; color:black; margin-top:10px; width:100%; font-size:0.8rem;">Diffuser Ãƒ  la communauté</button>
            </div>
            ...
            <div class="card" style="text-align:center; background:rgba(52, 152, 219, 0.05); border:1px solid #3498db;">
                ...
                <button data-action="payGarageEntryFee()" class="btn-insurance" style="background:#f1c40f; color:black; font-weight:bold;">S'acquitter du droit d'entrée (50â‚¬)</button>
                ...
                <div style="margin-top:15px; padding-top:15px; border-top:1px solid #444;">
                    ...
                    <button data-action="applyPartnerExemption()" class="btn-insurance fa-beat" style="background:transparent; border:1px solid #2ecc71; color:#2ecc71; margin-top:5px; font-size:0.8rem; font-weight:bold;">REJOINDRE LE RÃƒ‰SEAU GRATUITEMENT (-10%)</button>
                </div>
            </div>`
                : `
