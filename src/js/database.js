...
// Alias local pour rétrocompatibilité (déjà importé depuis config.js)
...
registerAction('triggerDGCCRFReport', triggerDGCCRFReport);
registerAction('applyAbuseSanction', applyAbuseSanction);
