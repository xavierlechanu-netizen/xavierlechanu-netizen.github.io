...
﻿/**
 * ADMINISTRATIVE TELEMETRY CONSOLE v110.00.00
...
hud.innerHTML = `
            <div class="telemetry-header">
                <span>SYSTEM_TELEMETRY v110.00.00</span>
                <button data-action="window.Telemetry.toggle()">[X]</button>
            </div>
            ...
            <div class="telemetry-actions">
                <button data-action="window.Telemetry.ping()">[ PING_SERVER ]</button>
                <button data-action="window.Telemetry.clearLogs()">[ CLEAR_LOGS ]</button>
            </div>
  ...
  clearLogs: function () {
    this.logs = [];
    const logEl = document.getElementById("telemetry-logs");
    if (logEl) // eslint-disable-next-line no-restricted-syntax
logEl.innerHTML = "";
