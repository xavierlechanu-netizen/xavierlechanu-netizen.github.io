...
```mermaid
graph TD
    A["Immatriculation ORIAS"] --> B["1. Capacité Professionnelle<br/>(Livret 150h ou diplôme)"]
    A --> C["2. Honorabilité<br/>(Casier judiciaire B2 vierge)"]
    A --> D["3. Assurance RC Pro<br/>(Garantie 1,5M€/sinistre)"]
    A --> E["4. Garantie Financière<br/>(Attestation non-encaissement)"]
    A --> F["5. Adhésion Asso Agréée<br/>(Planète CSCA / ENDYA / CNCEF)"]
```
